...
!
module data_file_gbl
use precisn_gbl
use const_gbl, only: line_len, level2, level3, no_header, mib
 ...
 10      read_header_obj = 2
   ...
   subroutine print_header_obj(this)
      ...
      class(data_header_obj) :: this
         ...
         write(level2,'(10x,"Contents of Data Header:")')

         write(level2,'("Header position: ",i0)') this%header_pos
         write(level2,'("Header: ",a)') this%name
         write(level2,'("Data set record start, end: ",i0," ",i0)') this%first_record, this%last_record
         write(level2,'("Data set size [Mib]: ",f25.15)') (this%last_record-this%first_record)/real(mib,kind=cfp)
         write(level2,'("Position of the next header: ",i0)') this%next_data

   end subroutine print_header_obj

   subroutine open_data_file(this,path)
      use const_gbl, only: data_file_obj_id, data_file_obj_id_10, data_file_obj_id_11, data_file_obj_id_12
      use mpi_gbl
      implicit none
      ...
      integer(kind=selected_int_kind(9)) :: flt_precision, int_bit_size
         ...
         this%identifier = data_file_obj_id
         if (ex) then

            if (myrank .eq. master) then
               read(this%unit,pos=1,iostat=err) this%identifier
               ...
               ! verify that the file has a supported version
               if (this%identifier /= data_file_obj_id_10 .and. &
                   this%identifier /= data_file_obj_id_11 .and. &
                   this%identifier /= data_file_obj_id_12) then
                  close(this%unit)
                  call xermsg ('data_file', 'open_data_file', &
            ...
            this%no_headers = 0
            if (myrank .eq. master) then
               write(this%unit,pos=1) this%identifier
         ...
         write(level2,'(/,"DATA FILE OPENED:",a)') path
         write(level2,'("File identifier: ",a)') this%identifier
   ...
   subroutine print_header_records(this)
      ...
      integer :: i
         ...
         if (this%no_headers .eq. 0) write(level2,'("The file is empty.")')

         write(level2,'("Number of data sets stored on the file: ",i0)') this%no_headers
         do i=1,this%no_headers
